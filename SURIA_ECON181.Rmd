...
```{r}
crypt1control <- lm(CRYPT ~ lagCRYPT + FBE + controlFBE, data = cause_lagged)
summary(crypt1control)
crypt2control <- lm(CRYPT ~ lagCRYPT + FFL + controlFBE, data = cause_lagged)
summary(crypt2control)
crypt3control <- lm(CRYPT ~ lagCRYPT + TBE + controlFBE, data = cause_lagged)
